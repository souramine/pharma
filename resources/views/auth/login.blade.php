...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <input type="password" placeholder="Mot de passe" name="password" id="password" class="form-control @error('password') is-invalid @enderror" required autocomplete="current-password">
            <button type="submit" id="login-button">Connecion</button><br><br>
