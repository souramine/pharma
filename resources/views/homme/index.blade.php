	...
	<head>
		...
		<body>	
		  			...
		  			<div class="container">
				  		<div class="row align-items-center">
				  			<div class="col-lg-6 col-sm-6 col-4 header-top-left no-padding">
				        		<h5><a href="#"><img src="{{asset('img/logo.png')}}" style="width: 5%" alt="" title="" /></a>	<strong style="color: black"> &nbsp;&nbsp;PHARMA SALIM</strong>		</h5>
				  			</div>
				  			<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
								<a class="btns" href="tel:+953 012 3654 896">+213678145295</a>
				  				<a class="btns" href="mailto:support@pharma.com">support@pharma.com</a>		
				...
				<div class="container">
					<div class="row fullscreen d-flex justify-content-center align-items-center">
						<div class="banner-content col-lg-9 col-md-12 justify-content-center">
							...
							<a href="#medi" class="primary-btn header-btn text-uppercase mt-10">lister les médicament</a>
						</div>											
					</div>
				</div>
			</section>
			...
			<section class="open-hour-area" id="lol">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-12 open-hour-wrap">
							<h1>Heure d'ouverture</h1>
							<p>
								Préparez-vous à voter et choisissez le bon
							</p>
							<a class="open-btn" href="#"> <span class="circle"></span>
Nous sommes ouverts maintenant</a>
					...
					<div class="row">
						<div class="active-testimonial-carusel">
							<div class="single-testimonial item">
								<img class="mx-auto" src="{{asset('img/homme/t1.png')}}" alt="">
								<p class="desc">
							...
							<div class="single-testimonial item">
								<img class="mx-auto" src="{{asset('img/homme/t2.png')}}" alt="">
								<p class="desc">
									Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
								</p>
								<h4>Mark Alviro Wiens</h4>
							...
							<div class="single-testimonial item">
								<img class="mx-auto" src="{{asset('img/homme/t3.png')}}" alt="">
								<p class="desc">
									Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
								</p>
								<h4>Mark Alviro Wiens</h4>
			...
			<section class="feature-area section-gap" id="medi">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">List des médicaments disponible</h1>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore  et dolore magna aliqua.</p>
							</div>
						</div>
					</div>	
          ...
          <table class="table table-striped projects" id="example1">
                ...
                @foreach ($lots as $l)
                  ...
                  @if($l->quantite_restante <= $l->quantite_minimum && $l->quantite_restante !=0)
                      ...
                      <td style="color: #003D6A"> 
                          ...
                          {{DB::table('medicaments')->where('id',$l->medicament_id)->pluck('unite_volume')->first()}}
                      </td>                  
                      <td>
                          {{$l->prix}} DA
                      </td>
			...
			<br>
			<!-- start banner Area -->
			<section class="banner-area relative about-banner" id="contact">	
				<div class="overlay overlay-bg"></div>
				<div class="container">				
						...
						<div class="col-lg-4 d-flex flex-column address-wrap">
							<div class="single-contact-address d-flex flex-row">
								...
								<div class="contact-details">
									<h5>Tlemcen, Algéria</h5>
									<p>
										Champ de tire les 400  
									</p>
								</div>
							</div>
							<div class="single-contact-address d-flex flex-row">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
			...
			<script src="{{asset('js/homme/vendor/jquery-2.2.4.min.js')}}"></script>
			<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
			<script src="{{asset('js/homme/vendor/bootstrap.min.js')}}"></script>			
			<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
  			<script src="{{asset('js/homme/easing.min.js')}}"></script>			
			<script src="{{asset('js/homme/hoverIntent.js')}}"></script>
			<script src="{{asset('js/homme/superfish.min.js')}}"></script>	
			<script src="{{asset('js/homme/jquery.ajaxchimp.min.js')}}"></script>
			<script src="{{asset('js/homme/jquery.magnific-popup.min.js')}}"></script>	
 			<script src="{{asset('js/homme/jquery-ui.js')}}"></script>			
			<script src="{{asset('js/homme/owl.carousel.min.js')}}"></script>						
			<script src="{{asset('js/homme/jquery.nice-select.min.js')}}"></script>							
			<script src="{{asset('js/homme/mail-script.js')}}"></script>	
			<script src="{{asset('js/homme/main.js')}}"></script>	
